 ...
 %File creation date: 10/27/18  at 11:06
...
\psset{linecolor=black,tnsep=1pt,tndepth=0cm,tnheight=0cm,treesep=1.2cm,levelsep=56pt,radius=10pt}
  \pstree[treemode=D]{\Tcircle{ \normalsize 1 }~[tnpos=l]{\shortstack[r]{\texttt{\detokenize{V1}}\\$\leq$14.85}}
    ~[tnpos=r]{\shortstack[r]{0.68\\0.32}}}{
  \pstree[treemode=D]{\Tcircle{ \normalsize 2 }~[tnpos=l]{\shortstack[r]{\texttt{\detokenize{sacral_slope}}\\$\leq$28.14}}
 }{
